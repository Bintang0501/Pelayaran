                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($penyijilan as $item)
                                            @if ($item->status_naik == 1 OR $item->status_naik == 3 OR $item->status_naik == 4)
											<tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    @else
                                                        <a href="{{ url('/kepala/penyijilan/download/' . $item->id) }}"
                                                            target="_blank">
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ url('/kepala/penyijilan/show/' . $item['id']) }}"
                                                        class="btn btn-primary btn-sm">
                                                        <i class="fa fa-search"></i> DETAIL
                                                    </a>
                                                </td>
                                            </tr>
											@elseif ($item->status_naik == 0 OR $item->status_naik == 2)
