                            ...
                            <form action="{{ url('/kepala/penyijilan/'.$detail['id']) }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <a href="{{ url('/kepala/penyijilan/unduh/'. $detail->id . '/ijazah') }}" class="btn btn-primary btn-sm">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Tanda Tangan Pejabat Pendaftaran
                                            Sijil</label>
                                        <div class="col-sm-10">
                                            <a href="{{ url('/kepala/penyijilan/unduh/'. $detail->id . '/ttd') }}" class="btn btn-primary btn-sm">
                                                <i class="fa fa-download"></i> UNDUH FILE
                                            </a>
                                        </div>
                                    </div>
