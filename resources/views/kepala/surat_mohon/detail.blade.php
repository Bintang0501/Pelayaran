		...
		<div class="row">
			<div class="col-12">
				<div class="card">
				  ...
				  <!-- /.card-header -->
                  <form action="{{ url('/kepala/surat_mohon/update/'.$detail['id']) }}" method="POST" class="form-horizontal"
                  enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                      <div class="card-body">
                        <a href="{{ url('/kepala/surat_mohon') }}" class="btn btn-warning btn-sm" style="margin-bottom: 10px">
