				...
				<div class="card">
				  ...
				  <div class="card-body">
					<table id="example2" class="table table-bordered table-hover">
						<a href="{{ url('/warga/surat_mohon/create') }}" class="btn btn-primary btn-sm" style="margin-bottom: 10px">
					  ...
					  <tbody>
						@foreach ($surat_mohon as $item)
							<tr>
								...
								<td class="text-center">
									<a href="{{ url('/warga/surat_pemohon/show/'.$item['no_buku_pelaut']) }}" class="btn btn-primary btn-sm">
