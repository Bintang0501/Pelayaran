                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card" style="background-color: rgb(209, 217, 226)">
                            ...
                            <!-- /.card-header -->
                            <form action="{{ url('/warga/penyijilan/update/' . $detail['id']) }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    @if ($detail->status_naik == 3)
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Status</label>
                                            <div class="col-sm-10">
                                                @if ($detail['status_turun'] == '0')
                                                    <button class="btn btn-secondary btn-sm">
                                                        <i class="fa fa-times"></i> Data Belum dikonfirmasi
                                                    </button>
                                                @elseif ($detail['status_turun'] == '1')
                                                    <button class="btn btn-success btn-sm">
                                                        <i class="fa fa-check"></i> Data Valid
                                                    </button>
                                                @elseif ($detail['status_turun'] == '2')
                                                    <button class="btn btn-danger btn-sm">
                                                        <i class="fa fa-times"></i> Data Tidak Valid
                                                    </button>
                                                @elseif ($detail['status_turun'] == '3')
                                                    <button class="btn btn-success btn-sm">
                                                        <i class="fa fa-check"></i> Disetujui
                                                    </button>
                                                @elseif ($detail['status_turun'] == '4')
                                                    <button class="btn btn-danger btn-sm">
                                                        <i class="fa fa-times"></i> Ditolak
                                                    </button>
                                                @endif
