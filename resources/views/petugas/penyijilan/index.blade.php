                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($penyijilan as $item)
                                            @if ($item->status_naik == 0 OR $item->status_naik == 1 OR $item->status_naik == 2)
											<tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    @else
                                                        <a href="{{ url('/petugas/penyijilan/download/' . $item->id) }}"
                                                            target="_blank">
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ url('/petugas/penyijilan/show/' . $item['id']) }}"
